...
class ReleaseTool:
    ...
    def __init__(self) -> None:
        ...
        self.parser.add_argument("--mode", '-m', choices=['release', 'install', 'debug'], default='debug', help="Mode of the app: Release, install or debug env.")
        self.parser.add_argument("--activity", '-a', choices=['FACR', 'Qual', 'Testing'], default='Testing', help="Activity the content will be used for.")
        ...
        self.install_group.add_argument("--container-name",type=str,default=None,help="Name of the docker container to build. Mandatory for debug.")
